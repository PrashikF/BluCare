		...
		<>
			...
			<div className={`mobile-shelf fixed inset-y-0 right-0 w-64 bg-bg-surface/95 backdrop-blur-xl z-[60] transform translate-x-full border-l border-light md:hidden`}>
				<div className="flex flex-col h-full p-8 pt-24 space-y-8">
					<a href="/app/chat/diagnostic" className="text-xl font-medium text-primary no-underline" onClick={toggleMobileMenu}>AI Diagnostic Chat</a>
					<a href="/app/hospitals" className="text-xl font-medium text-primary no-underline" onClick={toggleMobileMenu}>Hospital Finder</a>
