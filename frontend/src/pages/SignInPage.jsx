...
const SignInPage = () => {
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-bg-base relative overflow-hidden p-4">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 rounded-full bg-sage/10 blur-[120px] pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/3 w-80 h-80 rounded-full bg-lavender/10 blur-[100px] pointer-events-none" />
      ...
      <div className="w-full max-w-md z-10 space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-subdued uppercase tracking-widest font-mono">
            Clinical AI Healthcare Workspace
          </p>
        </div>
        ...
        <div className="flex items-center justify-center gap-1.5 text-[11px] text-subdued font-mono text-center">
          ...
          <span>256-Bit HIPAA Compliant Security Protocol</span>
        </div>
      </div>
    </div>
  );
